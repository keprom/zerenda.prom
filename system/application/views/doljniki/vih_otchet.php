...
<html>
<head>
<title>Отчет <?php echo $otchet_name;?></title>
<meta http-equiv="content-type" content="text/html; charset=utf-8" />

</head>
<center><b>Отчет <?php echo $otchet_name;?>по КГЭС (юридические лица)</b></center>
<br />
<center><?php echo $org_info->org_name;?> за <?php echo $period->name." ";?></center>
<?php 
$last_group=-1;
?>
