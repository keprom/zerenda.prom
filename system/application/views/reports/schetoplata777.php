...
if (strlen($data_schet)==0){ echo datetostring($schetfactura_date->date);} else { echo $data_schet;}?>
 ...
 <tr>
 <td align=left> Условия оплаты по договору (контракту) <u>договор</u></td>
 <td> (3а)</td>
 </tr>
 <tr>
 <td align=left> Пункт назначения поставляемых товаров (работ, услуг) _________________________</td>
 <td> (4)</td>
 </tr>
 <tr>
 ...
 <td> </td>
  ...
  <tr>
 <td align=left> Поставка товаров осуществлена по доверенности № ______________________________</td>
 <td> (5)</td>
 </tr>
 <tr>
 <td align=left> Способ отправления <u>транзит</u></td>
 <td> (6)</td>
 </tr>
 <tr>
 <td align=left> Грузоотправитель <u><?php echo $org->org_name." РНН ".$org->rnn;?></u></td>
 <td> (7)</td>
 </tr>
 <tr>
 <td align=left> Грузополучатель <u><?php echo $firm->name." РНН ".$firm->rnn;?></u></td>
 <td> (8)</td>
 </tr>
  <tr>
 <td align=left> Покупатель <?php echo $firm->name;?></td>
 <td> (8а)</td>
 </tr>
 <tr>
 <td align=left> РНН и адрес покупателя &nbsp;<u><?php echo $firm->rnn; ?></u> &nbsp;&nbsp;&nbsp; <u><?php echo $firm->address; ?></u></td>
 <td> (8б)</td>
 </tr>
 <tr>
 ...
 <TR>
  ...
  <TR>
	...
	<?php $sum_bez_nds=0;$sum_nds=0;$sum=0;$i=1;for($j=0;$j<$tariff_count;$j++):  if ($tariff_kvt[$j]==0) continue;?>
	  ...
	  <TR>
		...
		<TD vAlign=center align=middle><FONT size=1><?php echo (strlen($tovar_name)==0?"Электроэнергия":$tovar_name);?></FONT> 
  ...
  <TR>
    ...
    <TD align=right><FONT size=2><B>&nbsp;<?php echo f_d2($sum);?></B></FONT> 
    <TD align=right bgColor=#c0c0c0><FONT size=2>&nbsp;</FONT> 
    <TD align=right><FONT size=2><B>&nbsp;</B></FONT> </TD>
 
 </table>
 <center>
 <?php echo num2str(f_d($sum));?>
 </center>
	<br>
	<table width=100%  >
	<tr>
