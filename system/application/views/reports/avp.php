		...
		<table width='735px' cellspacing='7px'>
			...
			<tr>
				<td width='588px'>
					...
					<?php 
					echo " ".$firm->dogovor." ".datetostringg($firm->dogovor_date); 
					?> 
					</p>
				</td>
				<td width='147px'>
			...
			<table width='500px' border=1px cellspacing=0 cellpadding=0>
				...
				<tr>
					...
					if (strlen($data_schet)==0){ 
						echo datetostringg($schetfactura_date->date);
						} 
						else 
						{
							echo $data_schet; 
					...
					<p><?php
						echo datetostringg($period->begin_date);
						?></p>	
					</td>
					<td width='92px' align=center>
							<p><?php
						echo datetostringg($period->end_date);
						?></p>
					</td>
				</tr>
			</table>
