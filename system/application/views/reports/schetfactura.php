...
<FONT size=9>
 <table width=100%>
 <tr align=center>
 <td width=2100px> <b><?php echo $header; ?> №</b> <?php echo $number_schet.' от ';
if (strlen($data_schet)==0){ echo datetostring($schetfactura_date->date);} else { echo $data_schet;}?>
 ...
 <tr >
 <td width=2100px> БИН и адрес поставщика товаров, работ, услуг <?php echo " <u>".$org->bin." ".$org->address;?></u>
 </td>
 <td> (2а)</td>
 </tr>
 <tr>
 <td width=2100px> ИИК <u><?php echo $org->IIK;?> КБЕ-<?php echo $org->Bank_kbe;?> КНП-<?php echo $org->bank_knp;?> <?php echo $org->bank_name; ?>              
 ...
 <tr>
 <td width=2100px> БИН и адрес получателя товаров, работ, услуг   <u><?php echo $firm->address; ?></u></td>
 <td> (10а)</td>
 </tr>
 <tr>
 <td width=2100px> ИИК <u><?php echo $firm->raschetnyy_schet;?></u> в банке <u><?php echo $bank->name;?></u></td>
 <td> (10б)</td>
 </tr>
 </table>
 <br>
...
<?php  endforeach;?>
<tr align="center">
<td width="560px" colspan = "3" ><b align="left">Всего по счету:</b></td>
