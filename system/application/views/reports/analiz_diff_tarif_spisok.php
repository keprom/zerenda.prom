...
$sum_otp_nds+=($d->itogo_kvt_day+$d->itogo_kvt_night+$d->itogo_kvt_evening)*20.65;
...
$_sum_otp_nds+=($d->itogo_kvt_day+$d->itogo_kvt_night+$d->itogo_kvt_evening)*20.65;
...
<td>
	<?php echo f_d(($d->itogo_kvt_day+$d->itogo_kvt_night+$d->itogo_kvt_evening)*20.65);?>
</td> 

<td>
	<?php echo f_d((($d->tenge_day+$d->tenge_night+$d->tenge_evening)*($d->nds+100)/100)-(($d->itogo_kvt_day+$d->itogo_kvt_night+$d->itogo_kvt_evening)*20.65));?>
</td> 
