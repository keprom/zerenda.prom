...
if (strlen($data_schet)==0){ echo datetostring($schetfactura_date->date);} else { echo $data_schet;}?>
 ...
 <tr>
 <td width=2100px> Условия оплаты по договору (контракту)<u>                                                                                                                             </u></td>
 <td> (3а)</td>
 </tr>
 <tr>
 <td width=2100px> Пункт назначения поставляемых товаров (работ, услуг)<u>                                                                                                                                           </u></td>
 <td> (4)</td>
 </tr>
 <tr align=right>
 ...
 <td> </td>
  ...
  <tr>
 <td width=2100px> Поставка товаров осуществлена по доверенности №<u>                                                       </u></td>
 <td> (5)</td>
 </tr>
 <tr>
 <td width=2100px> Способ отправления <u>                                                                                                                                                    </u></td>
 <td> (6)</td>
 </tr>
 <tr>
 <td width=2100px> Товарно-транспортная накладная №_______________________     от ______________________________ </td>
 <td> (7)</td>
 </tr>
 <tr>
 <td width=2100px> Грузоотправитель <u>                                                                                                                     </u></td>
 <td> (8)</td>
 </tr>
 <tr align=right>
 ...
 <tr>
 <td width=2100px> Грузополучатель  <u>                                                                                                                     </u>   </td>
 <td> (9)</td>
 </tr>
 <tr align=right>
 <td width=2100px><i><FONT size=1>(РНН, наименование и адрес места нахождения)                                                                                                                        </font></i></td>
