...
<tr>
 ...
 <tr>
 <td width=2100px> Грузополучатель  <u><?php echo $firm->name; ?></u>  <u><?php echo $firm->address; ?></u> </td>
 <td> (8)</td>
 </tr>
  <tr>
 ...
 <tr>
 <td width=2100px> РНН и адрес покупателя   <u><?php echo $firm->rnn; ?></u>      <u><?php echo $edit6; ?></u></td>
 <td> (8б)</td>
 </tr>
 <tr>
