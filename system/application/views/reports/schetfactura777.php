...
<body>
 ...
 <tr align=center>
 <td width=2100px> 
 <b><?php echo $header; ?> №</b> <?php echo $number_schet.' от ';
...
<tr align="center">
	...
	<TD width="100px"><?php echo f_d($s2->tariff_value);?></td>
	<TD width="300px" align="right"><?php 
		echo (($itog->itog_tenge-$sum_bez_nds-$s2->tenge<0.1)?f_d($itog->itog_tenge-$sum_bez_nds):f_d($s2->tenge));
		$sum_bez_nds+=f_d($s2->tenge);	
	?></td>
	<TD width="110px"><?php echo f_d($s2->nds);?></td>
	<TD width="250px" align="right">
	<?php 
	echo (($itog->itogo_nds-$sum_nds-$s2->nds_value <0.1)? f_d($itog->itogo_nds-$sum_nds):f_d($s2->nds_value));
	$sum_nds+=f_d($s2->nds_value);?></td>
	<TD width="400px" align="right">
	<?php
		echo ($itog->itogo_with_nds-$sum-$s2->with_nds<0.1)?f_d($itog->itogo_with_nds-$sum):f_d($s2->with_nds);
		$sum+=f_d($s2->with_nds);
	?></td>
	<TD width="110px">0</td>
	<TD width="100px">0</TD>
...
<td width="100px"></td>
<td width="200px"><b><?php echo f_d($itog->itog_kvt);?></b></td>
<td width="100px"></td>
